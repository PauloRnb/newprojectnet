  ...
  return (
    <header className="z-10 hidden min-w-[375px] bg-gray-100 flex-col items-center dark:bg-zinc-900 32md:flex">
      <div className="flex w-full flex-col">
                            ...
                            <div className="ml-4 mt-5 flex flex-col justify-between h-full">
                                ...
                                <div className="mb-7 flex flex-col ml-0 gap-0">
                                  ...
                                  <NavigationMenu.Link asChild>
                                    <a
                                      ...
                                      className="ml-5 text-xs font-medium text-gray-500 dark:text-gray-300 focus:outline-none focus-visible:text-blue-700 dark:focus-visible:text-cyan-500"
                                    >
                                      (85) 9 9736-2750
                                    </a>
                                  </NavigationMenu.Link>
                              ...
                              <NavigationMenu.Link asChild>
                                <a
                                  ...
                                  rel="noopener noreferrer"
                                  aria-label="Abrir WhatsApp Com Mensagem Pré-Preenchida"
                                  className="bg-blue-700 flex items-center justify-center hover:bg-blue-500 dark:bg-cyan-400 dark:hover:bg-cyan-500 rounded-md py-2 focus:outline-none focus-visible:bg-blue-500 dark:focus-visible:bg-cyan-500"
                                >
                            ...
                            <div className="flex flex-col gap-3">
                              ...
                              <div className="flex flex-row items-center gap-5">
                                <NavigationMenu.Link asChild>
                                  <a
                                    ...
                                    className="group flex items-center justify-center gap-3 rounded-md py-2 transition-colors duration-300 bg-blue-700 hover:bg-blue-500 dark:bg-cyan-400 dark:hover:bg-cyan-500 w-[8.5rem] h-[2.4375rem] focus:outline-none focus-visible:bg-blue-500 dark:focus-visible:bg-cyan-500"
                                  >
                              ...
                              <NavigationMenu.Link asChild>
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="group h-12 w-[292px] flex items-center justify-center bg-center rounded-md border-2 border-blue-700 dark:border-cyan-400 hover:border-transparent hover:bg-blue-700 dark:hover:border-transparent dark:hover:bg-cyan-400 transition-colors duration-200 focus:outline-none focus-visible:border-transparent focus-visible:bg-blue-700 dark:focus-visible:bg-cyan-400"
                                >
                                  <p className="text-center font-medium text-base text-blue-700 group-hover:text-white dark:text-cyan-400 dark:group-hover:text-zinc-800 dark:group-focus-visible:text-zinc-800 group-focus-visible:text-white">
                        ...
                        <div className="flex flex-row gap-10">
                          <div className="flex flex-col gap-3">
                            ...
                            <NavigationMenu.Link asChild>
                              <Link
                                href="/fiber"
                                className="mt-3 text-base text-gray-600 hover:text-blue-700 leading-5 dark:text-cyan-400 dark:hover:text-cyan-500 font-semibold focus:outline-none focus-visible:text-blue-700 dark:focus-visible:text-cyan-500"
                              >
                                Plano Fibra
                              </Link>
                            </NavigationMenu.Link>
                            <NavigationMenu.Link asChild>
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-base text-gray-600 hover:text-blue-700 leading-5 dark:text-cyan-400 dark:hover:text-cyan-500 font-semibold focus:outline-none focus-visible:text-blue-700 dark:focus-visible:text-cyan-500"
                              >
                                2ª Via da Fatura
                              </a>
                            </NavigationMenu.Link>
        ...
        <Separator
          orientation="horizontal"
          className="w-full shrink-0 h-[1px] bg-gray-200 dark:bg-white"
        />
        {/* DropDown Menu Bottom Left */}
        <NavigationMenu.Root className="relative items-start justify-start container z-[1] md:px-6 32lg:px-0 32md:flex">
          <NavigationMenu.List className="group flex flex-1 list-none items-center justify-start h-[4.75rem] gap-6 space-x-0 xl:gap-10">
            <NavigationMenu.Item>
              <NavigationMenu.Trigger className="group flex select-none items-center justify-between gap-0.5 rounded leading-5 text-gray-600 hover:text-blue-700 group-focus:text-blue-800 dark:text-cyan-400 dark:hover:text-cyan-500 dark:group-focus:text-cyan-500 md:text-sm lg:text-base font-medium transition-colors duration-300 focus:outline-none">
                <h2 className="leading-5 text-gray-600 hover:text-blue-700 group-focus:text-blue-800 dark:text-cyan-400 dark:hover:text-cyan-500 dark:group-focus:text-cyan-500 md:text-sm lg:text-base group-focus-visible:text-blue-700 group-data-[active]:bg-blue-700 group-data-[state=open]:text-blue-700 dark:group-data-[state=open]:text-cyan-400">
                  ...
                  <div className="flex flex-col p-6">
                    ...
                    <div className="flex flex-row justify-normal mt-8">
                      ...
                      <div className="flex flex-col ml-8">
                        <div className="flex items-center justify-start gap-1 32md:gap-2">
                          <div className="w-3 h-3 flex items-center justify-center">
                            <span className="sr-only">Ícone de Empresa</span>
                            <RiBuilding2Line size={12} strokeWidth={0.8} />
                          </div>
                          <h3 className="select-none font-semibold tracking-[0.0375rem] text-gray-500 dark:text-white text-xs">
                            PARA A SUA EMPRESA
                        ...
                        <div className="ml-4 mt-5 flex flex-col">
                          ...
                          <div className="mb-7 flex flex-col ml-0 gap-0">
                            <div className="flex items-center gap-1">
                              <div className="w-4 h-4 flex items-center justify-center">
                                <span className="sr-only">Ícone de Email</span>
                                <Mail
                                  size={16}
                                  strokeWidth={1.8}
                                  className="text-gray-600 dark:text-white"
                ...
                <main className="hidden w-[25rem] rounded-xl border-none bg-white shadow-xl dark:bg-zinc-800 32md:block">
                  <div className="flex flex-col justiify-between p-6 gap-6">
                    <div className="flex flex-col">
                      ...
                      <div className="mt-8 flex flex-col">
                        <p className="text-gray-500 text-sm font-medium leading-4 dark:text-gray-300 mb-7">
                          Tenha acesso a suas faturas, informações do seu plano
                          e muito mais.
                        </p>
                        <div className="flex flex-col gap-3">
                          <div className="flex flex-row items-center justify-start gap-1">
          ...
          <div className="absolute left-0 top-[95%] flex justify-center">
            <NavigationMenu.Viewport className="origin-top-center text-popover-foreground relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md border bg-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 md:w-[var(--radix-navigation-menu-viewport-width)] border-none shadow-xl" />
          </div>
        </NavigationMenu.Root>
